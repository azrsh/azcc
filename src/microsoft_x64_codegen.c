...
const char *argumentRegister64[4] = {"rcx", "rdx", "r8", "r9"};
const char *argumentRegister32[4] = {"ecx", "edx", "r8d", "r9d"};
const char *argumentRegister16[4] = {"cx", "dx", "r8w", "r9w"};
const char *argumentRegister8[4] = {"cl", "dl", "r8b", "r9b"};
